...
// Get returns the value of the Env variable named by the key.
func (env Env) Get(key string) string {
	return env[key]
}

// String returns the string value of the Env variable named by the
...
// Bool returns the boolean value of the Env variable named by the key.
...
// Int returns the integer value of the Env variable named by the key.
// If the variable is not present, the default value is returned.
...
// Load reads the Env file and reads variables in "key=value" format.
// Then it read the system Env variables. It returns the combined
